                            ...
                            <table class="table table-bordered" id="9table1">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="unit_code' . $int . '"value = "' . $result->unit_code . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="asset_tag' . $int . '"value = "' . $result->asset_tag . '"id = "item" readonly> </td>
                                    <td><input type = "text"name="asset_desc' . $int . '"value = "' . $result->asset_desc . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="brand' . $int . '"value = "' . $result->brand . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="model' . $int . '"value = "' . $result->model . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="serial_no' . $int . '"value = "' . $result->serial_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="asset_class' . $int . '"value = "' . $result->asset_class . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="status' . $int . '"value = "' . $result->status . '" id = "item" readonly> </td>
                                    </td>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="6table2">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="cost' . $int . '"value = "' . $result->cost . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="warranty' . $int . '"value = "' . $result->warranty . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="build_loc' . $int . '"value = "' . $result->build_loc . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="floor' . $int . '"value = "' . $result->floor . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="spec_area' . $int . '"value = "' . $result->spec_area . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="note' . $int . '"value = "' . $result->note . '" id = "item" readonly> </td>
                                    </td>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="6table3">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="rr_no' . $int . '"value = "' . $result->rr_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="date_acq' . $int . '"value = "' . $result->date_acq . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="reference' . $int . '"value = "' . $result->reference . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="reference_date' . $int . '"value = "' . $result->reference_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="funded_by' . $int . '"value = "' . $result->funded_by . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="rs_no_transferred' . $int . '"value = "' . $result->rs_no_transferred . '" id = "item" readonly> </td>
                                    </td>
                                   <td class="toggleBtns">
                                    <button type = "submit" name ="button_pressed" value= "' . $int . '"  class="add" title="Add" data-toggle="tooltip" id="addbtn"><i class="material-icons">&#xE03B;</i></button>
                                    <a class = "edit" title="Edit" data-toggle="tooltip" id="editbtn"><i class="material-icons">&#xE254;</i></a>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="6table4">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="rs_date' . $int . '"value = "' . $result->rs_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="from_loc' . $int . '"value = "' . $result->from_loc . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="doc_no' . $int . '"value = "' . $result->doc_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="doc_no_date' . $int . '"value = "' . $result->doc_no_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="received_from' . $int . '"value = "' . $result->received_from . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="received_by' . $int . '"value = "' . $result->received_by . '" id = "item" readonly> </td>
                                    </td>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="4table5">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="pb_no' . $int . '"value = "' . $result->pb_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="pb_date' . $int . '"value = "' . $result->pb_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="id_no' . $int . '"value = "' . $result->id_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="person_accountable' . $int . '"value = "' . $result->person_accountable . '" id = "item" readonly> </td>
                                    </td>
                                   <td class="toggleBtns">
                                    <button type = "submit" name ="button_pressed" value= "' . $int . '"  class="add" title="Add" data-toggle="tooltip" id="addbtn"><i class="material-icons">&#xE03B;</i></button>
                                    <a class = "edit" title="Edit" data-toggle="tooltip" id="editbtn"><i class="material-icons">&#xE254;</i></a>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="3table6">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="ms_no' . $int . '"value = "' . $result->ms_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="ms_date' . $int . '"value = "' . $result->ms_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="moni_log' . $int . '"value = "' . $result->moni_log . '" id = "item" readonly> </td>
                                    </td>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="3table7">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="cr_no' . $int . '"value = "' . $result->cr_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="cr_date' . $int . '"value = "' . $result->cr_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="remarks' . $int . '"value = "' . $result->remarks . '" id = "item" readonly> </td>
                                    </td>
                                   <td class="toggleBtns">
                                    <button type = "submit" name ="button_pressed" value= "' . $int . '"  class="add" title="Add" data-toggle="tooltip" id="addbtn"><i class="material-icons">&#xE03B;</i></button>
                                    <a class = "edit" title="Edit" data-toggle="tooltip" id="editbtn"><i class="material-icons">&#xE254;</i></a>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="3table8">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="ar_no' . $int . '"value = "' . $result->ar_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="ar_date' . $int . '"value = "' . $result->ar_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="id_number' . $int . '"value = "' . $result->id_number . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="name_employee' . $int . '"value = "' . $result->name_employee . '" id = "item" readonly> </td>
                                    </td>
                                   <td class="toggleBtns">
                                    <button type = "submit" name ="button_pressed" value= "' . $int . '"  class="add" title="Add" data-toggle="tooltip" id="addbtn"><i class="material-icons">&#xE03B;</i></button>
                                    <a class = "edit" title="Edit" data-toggle="tooltip" id="editbtn"><i class="material-icons">&#xE254;</i></a>
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-bordered" id="3table9">
                                ...
                                <tbody>
                                    ...
                                    foreach ($results as $result) {
                                        echo ' <tr>
                                    <td><input type = "text"name="cs_no' . $int . '"value = "' . $result->cs_no . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="cs_date' . $int . '"value = "' . $result->cs_date . '" id = "item" readonly> </td>
                                    <td><input type = "text"name="moni_log_calibration' . $int . '"value = "' . $result->moni_log_calibration . '" id = "item" readonly> </td>
                                    </td> 
                                   <td class="toggleBtns">
                                    <button type = "submit" name ="button_pressed" value= "' . $int . '"  class="add" title="Add" data-toggle="tooltip" id="addbtn"><i class="material-icons">&#xE03B;</i></button>
                                    <a class = "edit" title="Edit" data-toggle="tooltip" id="editbtn"><i class="material-icons">&#xE254;</i></a>
