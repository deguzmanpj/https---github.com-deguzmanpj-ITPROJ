...
<body>
    ...
    <div class="container">
        ...
        <div class="table-title">
            ...
            <div class="row">
            <a href="{{ route ('admin/condemn_form')}}" class="btn btn-info add-new"><i class="fa fa-plus"></i>Add Entry</a>
            </div>
        </div>
    </div>
...
if (!empty($results)) {
    ...
    foreach ($results as $data) {
        ...
        // Check if cr_no has already been processed
        if (!in_array($crNo, $processedCrNos)) {
            ...
            echo '<div style="display: inline-block;">'; // Container for inline display
            echo '<form action="/decline_condemn" method="POST">'; // decline form
            echo '<input type="hidden" name="_token" value="' . csrf_token() . '">';
            ...
            // Update the processedCrNos array
            $processedCrNos[] = $crNo;
        }
    }
}
